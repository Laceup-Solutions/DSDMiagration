...
{
    class MilagroThreeInchesPrinter : ZebraThreeInchesPrinter1
    {
        ...
        protected override void FillDictionary()
        {
            ...
            linesTemplates[OrderCreatedReportHeader] = "^CF0,45^FO15,{0}^FDSales Register Report^FS^CF0,25^FO480,{3}^FDPage: {1}/{2}^FS";
            linesTemplates[PaymentReportHeader] = "^CF0,45^FO15,{0}^FDPayments Rec. Report^FS^CF0,25^FO480,{3}^FDPage: {1}/{2}^FS";
            linesTemplates.Add(OrderCreatedReportCompanyName, "^CF0,40^FO15,{0}^FD{1}^FS");
            linesTemplates.Add(OrderCreatedReportPageHeaderRight, "^FO100,{0}^CF0,20^FB200,1,0,R^FD{1}^FS^FO360,{0}^AON,20,20^FB200,1,0,L^FD{2}^FS");
            linesTemplates.Add(OrderCreatedReportPageHeaderLeft, "^FO15,{0}^CF0,20^FB100,1,0,R^FD{1}^FS^FO150,{0}^AON,20,20^FB300,1,0,L^FD{2}^FS");
            linesTemplates.Add(OrderCreatedreportSalesTypes, "^CF0,30^FO15,{0}^FD{1}^FS");

            linesTemplates.Add(CustomSignatureText, "^FO70,{0}^ADN,18,10^FDSales Rep.^FS^FO450,{0}^ADN,18,10^FDCashier^FS");
            linesTemplates.Add(CustomSignatureText1, "^FO70,{0}^ADN,18,10^FDSalesman Sign.^FS^FO410,{0}^ADN,18,10^FDWarehouse Sign.^FS");
            linesTemplates.Add(CustomSignature, "^FO15,{0}^ADN,18,10^FD---------------^FS^FO410,{0}^ADN,18,10^FD---------------^FS");
            linesTemplates.Add(CustomEndPage, "^FO0,{0}^ADN,18,10^FB730,1,0,C^FD***FINAL PRINT***^FS");

            linesTemplates.Add(SectionTotalSalesRegister, "^CF0,25^FO250,{0}^FD{1}^FS^CF0,25^FO450,{0}^FD{2}^FS");
            linesTemplates.Add(SectionTotalPaymentSubLine, "^CF0,25^FO120,{0}^FD{1}^FS^CF0,25^FO420,{0}^FD{2}^FS");


            linesTemplates[OrderCreatedReporWorkDay] = "^FO15,{0}^ADN,18,10^FDClock In: {1}  Clock Out: {2} Worked: {3}h:{4}m^FS";
            linesTemplates[OrderCreatedReporBreaks] = "^FO15,{0}^ADN,18,10^FDBreaks Taken: {1}h:{2}m^FS";
            linesTemplates[OrderCreatedReportTableHeader] =
                "^FO15,{0}^AON,25,25^FDAccount#^FS" +
                "^FO121,{0}^AON,25,25^FDDate^FS" +
                "^FO227,{0}^AON,25,25^FDInv #^FS" +
                "^FO333,{0}^AON,25,25^FDAmnt^FS" +
                "^FO439,{0}^AON,25,25^FDVar.^FS";
            linesTemplates[OrderCreatedReportTableLine] =
                "^FO15,{0}^AON,20,20^FD{1}^FS" +
                "^FO121,{0}^AON,20,20^FD{2}^FS" +
                "^FO227,{0}^AON,20,20^FD{3}^FS" +
                "^FO333,{0}^AON,20,20^FD{4}^FS" +
                "^FO439,{0}^AON,20,20^FD{5}^FS";
            linesTemplates[OrderCreatedReportTableLine1] = "^FO15,{0}^ANN,18,16^FDClock In: {1}    Clock Out: {2}     # Copies: {3}^FS";
            linesTemplates[OrderCreatedReportTableTerms] = "^FO15,{0}^ADN,18,10^FDTerms: {1}^FS";
            linesTemplates[OrderCreatedReportTableLineComment] = "^FO15,{0}^ABN,18,10^FDNS Comment: {1}^FS";
            linesTemplates[OrderCreatedReportTableLineComment1] = "^FO15,{0}^ABN,18,10^FDRF Comment: {1}^FS";
            ...
            linesTemplates[OrderCreatedReportPaidCust] = "^FO15,{0}^ABN,18,10^FDPaid Cust:           {1}^FS" +
                          "^FO500,{0}^ABN,18,10^FDVoided:       {2}^FS";
            linesTemplates[OrderCreatedReportChargeCust] = "^FO15,{0}^ABN,18,10^FDCharge Cust:         {1}^FS" +
                          "^FO500,{0}^ABN,18,10^FDDelivery:     {2}^FS";
            linesTemplates[OrderCreatedReportCreditCust] = "^FO15,{0}^ABN,18,10^FD^FS" +
                          "^FO500,{0}^ABN,18,10^FDP&P:          {2}^FS";
            linesTemplates[OrderCreatedReportExpectedCash] = "^FO15,{0}^ABN,18,10^FDExpected Cash Cust:  {1}^FS" +
                          "^FO500,{0}^ABN,18,10^FD  Refused:    {2}^FS";
            linesTemplates[OrderCreatedReportFullTotal] = "^FO15,{0}^ABN,18,10^FDTotal Sales:         {1}^FS" +
                          "^FO500,{0}^ABN,18,10^FDTime (Hours): {2}^FS";

            linesTemplates[OrderCreatedReportCreditTotal] = "^FO15,{0}^ABN,18,10^FD^FS" +
                          "^FO500,{0}^ABN,18,10^FDCredit Total: {2}^FS";
            linesTemplates[OrderCreatedReportNetTotal] = "^FO15,{0}^ABN,18,10^FD^FS" +
                          "^FO500,{0}^ABN,18,10^FD   Net Total: {2}^FS";
            linesTemplates[OrderCreatedReportBillTotal] = "^FO15,{0}^ABN,18,10^FD^FS" +
                          "^FO500,{0}^ABN,18,10^FD  Bill Total: {2}^FS";
            linesTemplates[OrderCreatedReportSalesTotal] = "^FO15,{0}^ABN,18,10^FD^FS" +
            ...
            linesTemplates[PaymentReportTableHeader] =
             "^FO15,{0}^AON,20,20^FDClient Name^FS" +
             "^FO121,{0}^AON,20,20^FDPayment^FS" +
             "^FO227,{0}^AON,20,20^FDInv#^FS" +
             "^FO333,{0}^AON,20,20^FDPaid^FS" +
             "^FO439,{0}^AON,20,20^FDVar.^FS";

            linesTemplates[PaymentReportTableHeader1] =
                "^FO15,{0}^AON,20,20^FDAccount #^FS" +
                "^FO121,{0}^AON,20,20^FDMethod^FS" +
                "^FO227,{0}^AON,20,20^FD^FS" +
                "^FO333,{0}^AON,20,20^FD^FS" +
                "^FO439,{0}^AON,20,20^FD^FS";

            linesTemplates[PaymentReportTableLine] =
             "^FO15,{0}^AON,20,20^FD{1}^FS" +
             "^FO121,{0}^AON,20,20^FD{2}^FS" +
             "^FO227,{0}^AON,20,20^FD{3}^FS" +
             "^FO333,{0}^AON,20,20^FD{4}^FS" +
            ...
            linesTemplates.Add(OrderCreatedReportPageHeaderRightMoreText, "^FO180,{0}^CF0,20^FB240,1,0,R^FD{1}^FS^FO430,{0}^AON,20,20^FB300,1,0,L^FD{2}^FS");
            linesTemplates.Add(OrderCreatedReportPageHeaderLeftMoreText, "^FO0,{0}^CF0,20^FB200,1,0,R^FD{1}^FS^FO210,{0}^AON,20,20^FB300,1,0,L^FD{2}^FS");

            #endregion

            #region Settlement

            linesTemplates[InventorySettlementHeader] = "^CF0,45^FO15,{0}^FDInventory Report^FS^CF0,25^FO480,{3}^FDPage: {1}/{2}^FS";
            linesTemplates[InventorySettlementProductHeader] = "";
            linesTemplates[InventorySettlementTableHeader] =
                "^FO15,{0}^AON,20,20^FDUoM^FS" +
                "^FO95,{0}^AON,20,20^FDLoad^FS" +
                "^FO175,{0}^AON,20,20^FDAdj^FS" +
                "^FO255,{0}^AON,20,20^FDSls^FS" +
                "^FO335,{0}^AON,20,20^FDDump^FS" +
                "^FO415,{0}^AON,20,20^FDUnl^FS" +
                "^FO495,{0}^AON,20,20^FDOver^FS";

            linesTemplates[InventorySettlementTableHeader1] =
             "^FO15,{0}^AON,20,20^FDProduct^FS" +
             "^FO95,{0}^AON,20,20^FD^FS" +
             "^FO175,{0}^AON,20,20^FD^FS" +
             "^FO255,{0}^AON,20,20^FD^FS" +
             "^FO335,{0}^AON,20,20^FD^FS" +
             "^FO415,{0}^AON,20,20^FD^FS" +
             "^FO495,{0}^AON,20,20^FD^FS";

            linesTemplates[InventorySettlementProductLine] = "^FO15,{0}^ABN,18,10^FD{1}^FS";
            linesTemplates[InventorySettlementLotLine] = "^FO15,{0}^ADN,18,10^FDLot: {1}^FS";
            linesTemplates[InventorySettlementTableLine] =
                "^FO15,{0}^AON,20,20^FD{1}^FS" +
                "^FO95,{0}^AON,20,20^FD{2}^FS" +
                "^FO175,{0}^AON,20,20^FD{3}^FS" +
                "^FO255,{0}^AON,20,20^FD{4}^FS" +
                "^FO335,{0}^AON,20,20^FD{5}^FS" +
                "^FO415,{0}^AON,20,20^FD{6}^FS" +
                "^FO495,{0}^AON,20,20^FD{7}^FS";
            ...
            linesTemplates[InventorySettlementAssetTracking] = "^FO15,{0}^CF0,33^FB620,1,0,L^FDCRATES: {1}^FS";
        ...
        protected override IEnumerable<string> GetOrderCreatedReportTable(ref int startY)
        {
            ...
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Refused:", reshipped));
            startY += font18Separation;
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Voided:", voided));
            startY += font18Separation;
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Delivery:", delivered));
            startY += font18Separation;
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Time (Hs):", totalTime));
            startY += font18Separation;
        ...
        protected IEnumerable<string> GetPaymentsReportTable(ref int startY, List<PaymentRow> rows, ref double negativeVariance, ref double positiveVariance)
        {
            ...
            if (creditAccountPayments.Count > 0)
            {
                ...
                lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[SectionTotalPaymentSubLine], startY, "Total Cash Collected: ", creditAccountPayments.Sum(x => x.PaidAmountNumber).ToCustomString()));
                startY += font18Separation;
                //total section
            }
            ...
            foreach (var pay in listToUse)
            {
                ...
                while (true)
                {
                    ...
                    if (index == 0)
                    {
                        ...
                        var paid = pay.Components[index].Amount;
        ...
        protected string GetPaymentReportTableLineFixed(string format, int pos, string v1, string v2, string v3, string v4, string v5)
        {
            return string.Format(CultureInfo.InvariantCulture, linesTemplates[format], pos,
                v1, v2, v3, v4, v5);
        }
        ...
        public override bool PrintReceivedPaymentsReport(int index, int count)
        {
            ...
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Cash Invoice Total:", cashInvoicesTotal.ToCustomString()));
            startY += font18Separation;
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Cash Received Total:", (cashPaid).ToCustomString()));
            startY += font18Separation;
            startY += font18Separation;

            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Check Invoice Total:", checkInvoicesTotal.ToCustomString()));
            startY += font18Separation;
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Checks Received:", (checkPaid).ToCustomString()));
            startY += font18Separation;
            startY += font18Separation;

            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Variance Owed:", positiveVariance.ToCustomString()));
            startY += font18Separation;
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Variance Over:", negativeVariance.ToCustomString()));
            startY += font18Separation;

            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Variances Cannot", string.Empty));
            startY += font18Separation;

            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "be combined:", string.Empty));
            startY += font18Separation;
            startY += font18Separation;
            ...
            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Expenses Total:", expensesTotal.ToCustomString()));
            startY += font18Separation;

            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Total Cash Deposit:", ((cashPaid + cashTotalFromAcc) - expensesTotal).ToCustomString()));
            startY += font18Separation;

            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "Check Deposit:", (checkPaid).ToCustomString()));
            startY += font18Separation;

            lines.Add(string.Format(CultureInfo.InvariantCulture, linesTemplates[OrderCreatedReportPageHeaderRight], startY, "POA Check Deposit:", cashTotalFromCheck.ToCustomString()));
            startY += font18Separation;
            startY += font18Separation;
        ...
        protected override IEnumerable<string> GetSettlementReportTable(ref int startY, List<InventorySettlementRow> map, InventorySettlementRow totalRow)
        {
            ...
            foreach (var group in SortDetails.SortedDetails(map).GroupBy(x => x.Product.Name))
            {
                ...
                foreach (var p in group)
                {
                    if (isFirstLine)
                    {
                        var newS1 = string.Format(CultureInfo.InvariantCulture, linesTemplates[InventorySettlementTableLine], startY,
                                              p.Product.Name,
                                              string.Empty,
                                              string.Empty,
                                              string.Empty,
            ...
            lines.Add(GetInventorySettlementTableTotalsFixed(InventorySettlementTableTotals, startY,
                                                string.Empty,
                                                Math.Round(totalRow.LoadOut + totalRow.BegInv, Config.Round).ToString(CultureInfo.CurrentCulture),
        ...
        protected string GetInventorySettlementTableLineFixed(string format, int pos, string v1, string v2, string v3, string v4, string v5, string v6, string v7)
        {
