...
{
    public class TextThreeInchesPrinter : TextPrinter
    {
        ...
        protected override void FillDictionary()
        {
            ...
            linesTemplates.Add(LoadOrderTableHeader, "PRODUCT                    UDM  ORDERED");
            ...
            linesTemplates.Add(AcceptLoadLotLine, "Lot: {1}");
            ...
            linesTemplates.Add(PaymentReportTableHeader,  "Name               Inv #      Inv Total Amount");
            linesTemplates.Add(PaymentReportTableHeader1, "                   Method     Ref Num");
            ...
            linesTemplates.Add(InventorySettlementTableHeader, "UoM    Beg  Load Adj  Tr.  Sls  Ret");
            linesTemplates.Add(InventorySettlementTableHeader1, "       Dump Rech Dmg  Unl  End  O/S");
            linesTemplates.Add(InventorySettlementProductLine, "{1}");
            linesTemplates.Add(InventorySettlementLotLine, "Lot: {1}");
            linesTemplates.Add(InventorySettlementTableLine, "{1} {2} {3} {4} {5} {6}");
            linesTemplates.Add(InventorySettlementTableTotals, "       {1} {2} {3} {4} {5} {6}");
            linesTemplates.Add(InventorySettlementTableTotals1, "       {1} {2} {3} {4} {5} {6}");
            #endregion
            ...
            linesTemplates.Add(InventorySummaryTableHeader1, "Lot  UoM  Ini.Inv Load Transf  Sales  Cur.Inv");
            ...
            linesTemplates.Add(RouteReturnsNotFinalLabel, "NOT FINAL ROUTE RETURN");
            ...
            linesTemplates.Add(ClientStatementTableHeader, "Type              Date             Number");
            linesTemplates.Add(ClientStatementTableHeader1, "Due Date          Amount           Open  ");
