...
{
    public partial class SalesProductCatReportPageViewModel : BaseReportPageViewModel
    {
        ...
        public SalesProductCatReportPageViewModel(DialogService dialogService, ILaceupAppService appService)
        ...
        protected override string GetReport(string command)
        {
            try
            {
                return DataProvider.GetSalesProdCatReport(command);
            }
            catch
            {
                throw;
