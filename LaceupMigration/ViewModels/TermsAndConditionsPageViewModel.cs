...
namespace LaceupMigration.ViewModels
{
	...
	public bool CanNavigateBack => Config.AcceptedTermsAndConditions;
		...
		//const terms text (SHOULD BE A STATIC RESOURCE 
		
		const string termsAndConditions = @"These Terms and Conditions (""Terms"") comprise the terms and conditions under which LaceUp Solutions will supply licenses and or Services. You accept these terms on behalf of the entity you represent (""Company"") (together with its Affiliates) by either: (i) physically or electronically signing the Terms; or (ii) placing an order with LaceUp Solutions on behalf of Company. Upon acceptance, the Terms will remain in effect until terminated by either party. Either party may terminate the Terms at any time and for any reason by providing prior written notice to the other party. Sections 1, 3, 4, 5, 6, 7, 8, 10, 11, 12, 14, 15, 16 and 17 will survive any termination of the Terms.
