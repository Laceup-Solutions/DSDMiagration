...
{
    public partial class LoadOrderReportPageViewModel : BaseReportPageViewModel
    {
        ...
        public LoadOrderReportPageViewModel(DialogService dialogService, ILaceupAppService appService)
        ...
        protected override string GetReport(string command)
        {
            try
            {
                return DataProvider.GetLoadOrderReport(command);
            }
            catch
            {
                throw;
