...
{
    public partial class NewOrderTemplatePage : LaceupContentPage, IQueryAttributable
    {
        private readonly NewOrderTemplatePageViewModel _viewModel;
        private readonly IScannerService _scannerService;

        public NewOrderTemplatePage(NewOrderTemplatePageViewModel viewModel, IScannerService scannerService)
        {
            InitializeComponent();
        ...
        {
            if (e.PropertyName == nameof(NewOrderTemplatePageViewModel.ActionButtonsColumnDefinitions) ||
                e.PropertyName == nameof(NewOrderTemplatePageViewModel.ShowAddCredit))
            {
                UpdateColumnDefinitions();
            }
        }
        ...
        protected override string? GetRouteName() => "newordertemplate";
