...
{
    public partial class SentOrdersPage 
    {
        private readonly SentOrdersPageViewModel _viewModel;

        public SentOrdersPage(SentOrdersPageViewModel viewModel)
        {
            InitializeComponent();
        ...
        protected override string? GetRouteName() => "sentorders";
